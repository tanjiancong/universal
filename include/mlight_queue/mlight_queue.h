...
\desc       create
*/
#if !defined(__mlight_queue_h__)
#define __mlight_queue_h__
...
#endif
#include "mlight_queue/mlight_queue_api.h"
...
#       define mlib_mframework_prefix   "mlight_queue"
#   endif
/* comment lib */
#   if defined(_LIB)
#       if defined(_DEBUG)
...
#endif /* !defined(__mlight_queue_h__) */
