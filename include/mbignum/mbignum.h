/*!
\file       mbignum.h
\brief      mbignum include file list
...
\desc       create
*/
#if !defined(__mbignum_h__)
#define __mbignum_h__
...
#       define mlib_mframework_prefix   "mbignum"
#   endif
/* comment lib */
#   if defined(_LIB)
#       if defined(_DEBUG)
