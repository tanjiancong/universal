...
typedef struct bn_gencb_st
{
    ...
    union
    {        
        void        (* cb_1)(int, int, void *);      /* if(ver==1) - handles old style callbacks */        
        int         (* cb_2)(int, int, struct bn_gencb_st *);  /* if(ver==2) - new callback style */
    } cb;
} BN_GENCB;
...
{    
    ...
    unsigned int    depth, size;                /* Number of stack frames, and the size of the allocated array */
} BN_STACK;
...
typedef struct bn_blinding_st
{
    ...
    unsigned long   thread_id; /* added in OpenSSL 0.9.6j and 0.9.7b; used only by crypto/rsa/rsa_eay.c, rsa_lib.c */
