/*!
\file       mip_tree.h
\brief      mip_tree include file list
...
\desc       create
*/
#if !defined(__mip_tree_h__)
#define __mip_tree_h__
...
#       define mlib_mframework_prefix   "mip_tree"
#   endif
/* comment lib */
#   if defined(_LIB)
#       if defined(_DEBUG)
