/*!
\file       mip_location.h
\brief      mip_location include file list
...
\desc       create
*/
#if !defined(__mip_location_h__)
#define __mip_location_h__
...
#endif
#include "mip_location/ip_location.h"
...
#       define mlib_mframework_prefix   "mip_location"
#   endif
/* comment lib */
#   if defined(_LIB)
#       if defined(_DEBUG)
...
#endif /* !defined(__mip_location_h__) */
