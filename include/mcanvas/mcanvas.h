...
/*!
\file       mcanvas.h
\brief      mcanvas include file list
...
\desc       create
*/
#if !defined(__mcanvas_h__)
#define __mcanvas_h__
...
#       define mlib_mframework_prefix   "mcanvas"
#   endif
/* comment lib */
#   if defined(_LIB)
#       if defined(_DEBUG)
