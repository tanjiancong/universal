/*!
\file       mmedia.h
\brief      mmedia include file list
...
#endif
#include "mmedia/media_channel_def.h"
#include "mmedia/media_channel.h"
#if !defined(media_channel_def_ex_disable)
#include "mmedia/media_channel_def_ex.h"
#endif
...
#       define mlib_mframework_prefix   "mmedia"
#   endif
/* comment lib */
#   if defined(_LIB)
#       if defined(_DEBUG)
