/*!
\file       mhashmap.h
\brief      mhashmap include file list
...
#       define mlib_mframework_prefix   "mhashmap"
#   endif
/* comment lib */
#   if defined(_LIB)
#       if defined(_DEBUG)
