...
\desc       create
*/
#if !defined(__mwificode_h__)
#define __mwificode_h__
...
#endif
#include "mwificode/mwificode_type.h"
#include "mwificode/mwificode_api.h"
...
#       define mlib_mframework_prefix   "mwificode"
#   endif
/* comment lib */
#   if defined(_LIB)
#       if defined(_DEBUG)
