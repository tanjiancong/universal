...
\desc       create
*/
#if !defined(__mocde_gen_h__)
#define __mocde_gen_h__
...
#       define mlib_mframework_prefix   "mcode_gen"
#   endif
/* comment lib */
#   if defined(_LIB)
#       if defined(_DEBUG)
